...
struct StationMapView: View {
  ...
  @State private var selectedStation: Station = .example
  ...
  var body: some View {
    ...
    .bottomSheet(
      ...
      switchablePositions: [.relative(0.2), .dynamic]
    ) {
      LineSelectorView( /* selectedLine: $selectedLine */ )
    }
  }
...
//    }
  StationMapView().modelContainer(for: Station.self)
}
